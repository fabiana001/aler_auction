...
class AuctionExtractor:
    ...
    def extract_from_file(self, file_path: str | Path, source_url: str | None = None) -> list[dict[str, Any]]:
        ...
        return self._parse_table(table, auction_date_str, source_file=path.name, source_url=source_url)
    ...
    def _parse_table(self, table: Tag, auction_date: str, source_file: str, source_url: str | None = None) -> list[dict[str, Any]]:
