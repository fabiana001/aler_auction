...
def main():
    ...
    input_dir = Path("data/raw/historical_auction_data")
    output_json = Path("data/interim/extracted_pdf_results.json")
    output_csv = Path("data/interim/extracted_pdf_results.csv")
