...
def main():
    ...
    properties_path = data_dir / "interim" / "extracted_auctions.csv"
    results_path = data_dir / "interim" / "extracted_pdf_results.csv"
    output_path = data_dir / "interim" / "consolidated_auction_dataset.csv"
